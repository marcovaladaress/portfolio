    ...
    <div className="px-5 pt-11 md:container md:mx-auto md:px-0 md:pt-6">
      <div className="md:mt-12 md:ml-15 md:flex md:flex-col md:gap-15">
        <div className="space-y-5">
          ...
          <h1 className="text-3xl leading-11 font-medium md:max-w-5xl md:text-start md:text-6xl md:leading-18">
            Desenvolvedor Full Stack focado em {""}
            <span className="text-[#8B5CF6]">sistemas escaláveis</span> ,
            seguros e orientados a negócio
          </h1>
          <p className="text-muted-foreground mt-6 text-[17px] leading-7 md:max-w-3xl md:text-xl md:leading-10">
